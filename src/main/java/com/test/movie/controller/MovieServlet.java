...
import com.test.movie.model.MovieService;
import com.test.movie.model.MovieVO;
		...
		if ("update".equals(action)) { // 來自update_emp_input.jsp的請求
			...
			req.setAttribute("errorMsgs", errorMsgs);
				...
				if (movieName == null || movieName.trim().length() == 0) {
					...
					errorMsgs.add("電影名稱: 只能是中、英文字母、數字和_ , 且長度必需在2到10之間");
	            }
				...
				try {
				    ...
				    errorMsgs.add("請填數字:0.普遍級1.保護級2.輔導級3.限制級");
				}
